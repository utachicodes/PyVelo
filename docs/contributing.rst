Contributing to PyVelo
======================

If you wish to contribute a fix or feature to PyVelo, please follow the following
guidelines.

When you make a pull request against the main PyVelo codebase, Github runs the test
...
PyVelo uses pre-commit_ to perform several code style/quality checks. It is
...
#. Fork the repository (if you don't have your own fork of it yet) by navigating to the
   `main PyVelo repository`_ and clicking on "Fork" near the top right corner.
#. Clone the forked repository to your local machine with
   ``git clone git@github.com/utachicodes/pyvelo``.
...
.. _main PyVelo repository: https://github.com/utachicodes/pyvelo
